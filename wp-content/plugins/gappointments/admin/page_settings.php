			...
			<table class="form-table">
				...
				<tr>
					...
					<td>
						...
						<p>Shortcodes to use: {service_name} | {appointment_date} | {client_name} | {client_email} | {client_phone} | {provider_name}<?php

                        /**
						 *  Google calendar event description hint filter
						 *  @since 1.9.6
						 *  @see gappointments/appointments/event_description_hint filter: define additional hints in Google cal. event description.
						 *  @return string Custom hints string.
						*/
						$custom_hints = apply_filters( 'gappointments/appointments/event_description_hint', '' );
						if( !empty( $custom_hints ) && is_string( $custom_hints ) ) {
							echo esc_html( $custom_hints );
						}
						?></p>
					</td>
				</tr>
			...
			<table class="form-table">
				...
				<tr>
					...
					<td>
						...
						<p class="description">Shortcodes to use: [week_long], [day], [year], [time_start], [time_end]</p>
					</td>
				</tr>
